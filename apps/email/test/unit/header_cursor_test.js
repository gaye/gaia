...
suite('HeaderCursor', function() {
  ...
  suite('#die', function() {
    ...
    test.skip('should stop listening to model for folder events', function() {
      // TODO(gaye)
    });
  });

  suite('#onLatestFolder', function() {
    test.skip('should update messagesSlice', function() {
      // TODO(gaye)
    });
  });

  suite('#onMessagesSpliceComplete', function() {
    test.skip('should get new message from messagesSlice on spill', function() {
      // TODO(gaye)
    });

    test.skip('should emit currenentMessage when spill sibling', function() {
      // TODO(gaye)
    });
  });
});
